...
echo -e "${Yellow}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${Reset}"
echo -e ""
echo -e " [${Blue}1${Reset}] Create VLESS Account"
echo -e " [${Blue}2${Reset}] Trial VLESS Account"
echo -e " [${Blue}3${Reset}] Extend VLESS Account"
echo -e " [${Blue}4${Reset}] Delete VLESS Account"
echo -e " [${Blue}5${Reset}] Check VLESS Logins"
